...
const offlineData: OfflinePromptData = {
  subjects: [
    'A stunning woman with piercing eyes',
    'A weathered man with character lines',
    'A child laughing with pure joy',
    'An elderly couple holding hands',
    'A professional in sharp business attire',
    'A dancer mid-movement',
    'A musician lost in performance',
    'A athlete in peak form',
    'A model with high fashion styling',
    'An exotic person from diverse culture',
    'A family embracing tightly',
    'A lone traveler with wanderlust eyes',
  ],
  environments: [
    'lush tropical paradise with vibrant foliage',
    'pristine mountain peaks with snow',
    ...
    'bustling metropolitan cityscape',
    'quiet coastal village',
    'vast open prairie',
    'underground cavern with crystal formations',
...
/**
 * Generate a professional prompt using offline data
